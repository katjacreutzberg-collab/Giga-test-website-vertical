...
(function () {
  ...
  var T = {
    nl: {
      ...
      'ref-sub':          'Van de Cooltoren in Rotterdam tot torens in Parijs en Londen — elk project bewijst wat directe fabrieksaccess, technische precisie en groothandelsexpertise in de praktijk kunnen bereiken.',
    ...
    en: {
      ...
      'ref-sub':          'From the Cooltoren in Rotterdam to towers in Paris and London — every project proves what direct factory access, technical precision and wholesale expertise can achieve in practice.',
